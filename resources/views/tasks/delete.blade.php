...
<div class="card card-info list-group-item list-group-item-primary">
    <div class="card-header with-border d-flex justify-content-between align-items-left card text-white bg-primary mb-3">
        <div class="row">
            <div class="col-md-4">Delete Task</div>
                 ...
                 {{ csrf_field() }}
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="task_name" value="{{$task->name}}" class="form-control"  aria-describedby="taskname" placeholder="Enter Task" readonly>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="project_id" readonly>
